    ...
    <body>
        ...
        <main>
            ...
            <div id="textovideo">
                ...
                <iframe class="ytb-embed" width="560" height="390" src="https://www.youtube.com/embed/36e-f-xAgQM?autoplay=1&rel=0&showinfo=0&controls=1" frameborder="0" allowfullscreen></iframe>
            </div>
             ...
             <section id="artistas">
                ...
                <div class="containerartistas">
                    <div class="info-artistas">
                     ...
                     <div class="info-artistas">
                        <img id="song2" src="IMG/rose-min.jpg" alt="">
                         <h5>test</h5> 
                    </div>
                     ...
                     <div class="info-artistas">
                        <img id="song4" src="IMG/rose-min.jpg" alt="">
                         <h5>test</h5>                         
                    </div>
                     ...
                     <div class="info-artistas">
                        <img id="song6" src="IMG/rose-min.jpg" alt="">
                         <h5>test</h5> 
                    </div>
                <hr color="dodgerblue" size=1>
                </div>
