...
<body>
  ...
  <div class="contieneFormR">
    ...
    <p id="titulo2"> edita tus datos Recuerda llenar todos los Campos </p>

      <form class="form-horizontal" role="form" method="POST" action="{{ url('updateda') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ Auth::user()->name }}" required autofocus disabled="disabled">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ Auth::user()->email }}" required disabled="disabled">
                     ...
                     <div> <input type="date" name="fecha" value="{{ Auth::user()->Fecha_Nacimiento }}"></div>
